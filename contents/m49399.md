...
<div data-type="exercise">
<div data-type="problem">
<table summary="Two columns, eight rows. The table has ordered pairs of these row values: (x,y), (0,-1), (pi/4, 2), (pi/2, 5), (3pi/4, 2), (pi, -1), (5pi/4, 2), (3pi/2, 5)." class="unnumbered" data-label=""><caption><span data-type="title" /></caption><tbody>
    <tr>
     <td><strong><math xmlns="http://www.w3.org/1998/Math/MathML">
      <mi>x</mi>
     </math>
