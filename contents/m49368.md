...
[[link]](#Table_04_08_03) shows the average life expectancies, in years, of Americans from 1900–2010<span data-type="footnote">Source: *Center for Disease Control and Prevention, 2013*</span>.
...
Mobile telephone service has increased rapidly in America since the mid 1990s. Today, almost all residents have cellular service. [[link]](#Table_04_08_05) shows the percentage of Americans with cellular service between the years 1995 and 2012 <span data-type="footnote">Source: *The World Bank, 2013*</span>.
...
<div data-type="solution" markdown="1">
about<math xmlns="http://www.w3.org/1998/Math/MathML"> <mrow> <mtext> </mtext><mn>5.4</mn><mtext> </mtext> </mrow> </math>
...
{: #Table_04_08_07 summary="Two rows and seven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 1125), (2, 1495), (3, 2310), (4, 3295), (5, 4650), and (6, 6361)."}
...
{: #Table_04_08_08 summary="Two rows and seven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 555), (2, 383), (3, 307), (4, 210), (5, 158), and (6, 122)."}
...
{: #Table_04_08_09 summary="Two rows and seven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 5.1), (2, 6.3), (3, 7.3), (4, 7.7), (5, 8.1), and (6, 8.6)."}
...
{: #Table_04_08_10 summary="Two rows and nine columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 7.5), (2, 6), (3, 5.2), (4, 4.3), (5, 3.9), (6, 3.4), (7, 3.1), and (8, 2.9)."}
...
{: #Table_04_08_11 summary="Two rows and eleven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 8.7), (2, 12.3), (3, 15.4), (4, 18.5), (5, 20.7), (6, 22.5), (7, 23.3), (8, 24), (9, 24.6), and (10, 24.8)."}
...
{: #Table_04_08_12 summary="Two rows and eleven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (0, 12), (2, 28.6), (4, 52.8), (5, 70.3), (7, 99.9), (8, 112.5), (10, 125.8), (11, 127.9), (15, 135.1), and (17, 135.9)."}
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Solve for<math xmlns="http://www.w3.org/1998/Math/MathML"> <mrow> <mtext> </mtext><mi>x</mi><mtext> </mtext><mtext> </mtext><msub> <mrow> <mi>log</mi></mrow> <mrow> <mn>64</mn></mrow> </msub> <mo stretchy="false">(</mo><mi>x</mi><mo stretchy="false">)</mo><mo>=</mo><mfrac> <mn>1</mn> <mn>3</mn> </mfrac> <mtext> </mtext></mrow> </math>
...
{: summary="Two rows and eleven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 3.05), (2, 4.42), (3, 6.4), (4, 9.28), (5, 13.46), (6, 19.52), (7, 28.3), (8, 41.01), (9, 59.5), and (10, 86.28)." .unnumbered data-label=""}
...
{: summary="Two rows and twelve columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (0.5, 18.05), (1, 17), (3, 15.33), (5, 14.55), (7, 14.04), (10, 13.5), (12, 13.22), (13, 13.1), (15, 12.88), (17, 12.69), and (20, 12.45)." .unnumbered data-label=""}
...
## [Fitting Exponential Models to Data](/49368){: .target-chapter}
...
{: summary="Two rows and eleven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 409.4), (2, 260.7), (3, 170.4), (4, 110.6), (5, 74), (6, 44.7), (7, 32.4), (8, 19.5), (9, 12.7), and (10, 8.1)." .unnumbered data-label=""}
...
{: summary="Two rows and eleven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (0, 9), (2, 22.6), (4, 44.2), (5, 62.1), (7, 96.9), (8, 113.4), (10, 133.4), (11, 137.6), (15, 148.4), and (17, 149.3)." .unnumbered data-label=""}
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
The graph below shows transformations of the graph of<math xmlns="http://www.w3.org/1998/Math/MathML"> <mrow> <mtext> </mtext><mi>f</mi><mo stretchy="false">(</mo><mi>x</mi><mo stretchy="false">)</mo><mo>=</mo><msup> <mrow> <mrow><mo>(</mo> <mrow> <mfrac> <mn>1</mn> <mn>2</mn> </mfrac> </mrow> <mo>)</mo></mrow> </mrow> <mi>x</mi> </msup> <mo>.</mo><mtext> </mtext> </mrow> </math>
...
{: #Table_04_08_14 summary="Two rows and eleven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 3), (2, 8.55), (3, 11.79), (4, 14.09), (5, 15.88), (6, 17.33), (7, 18.57), (8, 19.64), (9, 20.58), and (10, 21.42)."}
...
{: summary="Two rows and eleven columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (1, 20), (2, 21.6), (3, 29.2), (4, 36.4), (5, 46.6), (6, 55.7), (7, 72.6), (8, 87.1), (9, 107.2), and (10, 138.1)." .unnumbered data-label=""}
...
{: summary="Two rows and twelve columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (3, 13.98), (4, 17.84), (5, 20.01), (6, 22.7), (7, 24.1), (8, 26.15), (9, 27.37), (10, 28.38), (11, 29.97), (12, 31.07), and (13, 31.43)." .unnumbered data-label=""}
...
{: summary="Two rows and twelve columns. The first row is labeled, &#x201C;x&#x201D;, and the second row is labeled, &#x201C;f(x)&#x201D;. Reading the columns as ordered pairs, we have the following values: (0, 2.2), (0.5, 2.9), (1, 3.9), (1.5,4.8), (2, 6.4), (3, 9.3), (4, 12.3), (5, 15), (6, 16.2), (7, 17.3), and (8, 17.9)." .unnumbered data-label=""}
